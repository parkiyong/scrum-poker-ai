        ...
        <div className="p-3 bg-slate-950/50 border-b border-slate-800 flex flex-wrap items-center justify-between gap-2">
          {isFacilitator && (
            <button
              ...
              className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-bold shadow transition flex items-center gap-1.5"
            >
              ➕ Import Backlog
            </button>
          )}
          ...
          <div className="flex items-center gap-1.5 ml-auto">
            <button
              ...
              className="px-2.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-xl text-xs font-semibold border border-slate-700 transition flex items-center gap-1 disabled:opacity-40"
        ...
        <div className="p-3 space-y-2.5 overflow-y-auto flex-1">
          {backlog.length === 0 ? (
            <div className="h-64 flex flex-col items-center justify-center text-center p-6 text-slate-500 space-y-2">
              ...
              <p className="text-xs font-medium">No stories in the backlog queue yet.</p>
              {isFacilitator && (
                <button
                  onClick={onOpenConnectModal}
                  className="mt-2 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-indigo-300 rounded-xl text-xs font-semibold border border-indigo-500/20 transition"
                >
                      ...
                      {isActive ? (
                        ...
                        isFacilitator && (
                          <button
                            ...
                            className="px-2 py-1 bg-slate-800 hover:bg-indigo-600 text-slate-200 hover:text-white rounded-lg text-[11px] font-bold transition shadow"
                          >
                            🎯 Estimate
                          </button>
                        )
                    ...
                    <div className="flex items-center justify-between pt-1 border-t border-slate-800/60 text-[10px] text-slate-500">
                      <div className="flex items-center gap-1">
                        <button
                          ...
                          disabled={index === 0}
                          className="px-1.5 py-0.5 hover:bg-slate-800 hover:text-slate-300 rounded transition disabled:opacity-20"
                          title="Move up"
                        >
                          ▲
                        </button>
